...
echo
echo "=== friezer.eu ==="
echo "=== https://github.com/Friezer-85 ==="
echo "=== MikroTik 7.17 Elseif Installer ==="
echo
sleep 3
wget https://github.com/elseif/MikroTikPatch/releases/download/7.17/chr-7.17.img.zip -O chr.img.zip  && \
